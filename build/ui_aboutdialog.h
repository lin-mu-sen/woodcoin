...
""));
    ...
    {
        AboutDialog->setWindowTitle(QApplication::translate("AboutDialog", "About Woodcoin", Q_NULLPTR));
        label->setText(QApplication::translate("AboutDialog", "<b>Woodcoin</b> version", Q_NULLPTR));
